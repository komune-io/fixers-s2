...
import s2.sample.orderbook.sourcing.core.OrderBookModelView
import s2.sample.orderbook.sourcing.core.OrderBookSnapView
...
class OrderBookAutomateConfig(
	...
	override fun automate() = orderBookAutomate("sourcing-mongodb")
