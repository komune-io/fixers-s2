...
open class S2AutomateExecutorSpring<STATE, ID, ENTITY> :
    ...
    protected lateinit var automateExecutor: S2AutomateExecutor<STATE, ENTITY, ID, Evt>
    protected lateinit var automateExecutorFlow: S2AutomateExecutorFlow<STATE, ENTITY, ID, Evt>
